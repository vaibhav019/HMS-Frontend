...
export default function BloodDonationPage() {
  ...
  return (
    ...
    <div>
    <Container fluid className='mb-3 p-3'> <h4 >Apply for blood Donation </h4></Container>
  ...
  <Col sm={4}></Col>
    ...
    <Form.Control type='number'  id="weight"  placeholder="Enter Weight"/>
  </Form.Group>
    </Col>
    <Col sm={4}><Form.Group className="mb-3" controlId="bloodgroup">
